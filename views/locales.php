        ...
        <form action="?controlador=Local&accion=busquedaLocales" method="POST">
          ...
          <div class="row">
            ...
            <ul id="portfolio-grid" class="thumbnails row">
                ...
                <div class="thumbnail">
                    <img src="assets/images/locales/<?php echo $key['fotografia'];?>" height='640' width='400' alt="project 1">
        ...
        <div class="modal-body">
          <form  method="post" action="?controlador=TercerTiempo&accion=ingresarTercerTiempo" class="design-form" >
            <div class="container">  
              ...
              <input type="number" name="idLocal" value="<?php echo $idLocal ?>" hidden></input>
              <div class="row">
                <div class="col-sm-8">
                  <div class="form-group">
