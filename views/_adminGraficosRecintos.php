...
$(function () {
        ...
        title: {
            text: 'Top 10 recintos con más partidos'
        },
        subtitle: {
            text: 'Matchday'
        },
...
$('#containerRecintos2').highcharts({
        ...
        title: {
            text: 'Superficie canchas del sistema' //titulo
        },
        tooltip: {
...
$('#containerRecintos3').highcharts({
        ...
        title: {
            text: 'Precio mas alto por recinto' //titulo
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
$('#containerRecintos4').highcharts({
        ...
        title: {
            text: 'Precio mas bajo por recinto' //titulo
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
