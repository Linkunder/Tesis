...
class Contacto{
	...
	public function getContactos($idUsuario){
		$query = $this->db->prepare("SELECT Usuario.idUsuario, Usuario.nombre, Usuario.apellido, Usuario.nickname, Usuario.mail, Usuario.fotografia, Usuario.fechaNacimiento, Usuario.telefono
			FROM Usuario 
